...
//fichier de la commande de /stand
public class Stand implements IComand {
    ...
    //appèle les bonnes fonctions du fichier de blackjack quand le joueur fait la commande /stand
    @Override
